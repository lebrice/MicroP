...
//// TODO: This method was commented out because there is already initialization code provided by cube in "spi.c", and the 
//// settings seem to match between the two.
