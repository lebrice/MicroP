...
\begin{minipage}{0.45\textwidth}
	...
	\hline 
	\end{tabular} 
	\caption{Output of the keypad FSM, depending on which row is currently set, and which column read returns a '1'. Note that the '0' key on our keypad was dysfunctional.}
\end{minipage}
...
\end{lstlisting}
	\caption{Main Keypad thread logic}
	\label{fig:keypad_thread_main_logic}
\end{minipage}
