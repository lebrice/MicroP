...
A comprehensive discussion of the performance and tradeoffs associated with each controller can be found within Section~\ref{section:testing_and_observations} (testing and observations).
